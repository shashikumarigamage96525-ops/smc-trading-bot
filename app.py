...
st_autorefresh(
    interval=5000,
    limit=None,
    key="institutional_terminal_refresh"
)
...
def binance_get(endpoint, params=None, timeout=5):
...
def fetch_order_book_metrics(symbol):
    ...
    bid_pressure = bids / total * 100
    ask_pressure = asks / total * 100
